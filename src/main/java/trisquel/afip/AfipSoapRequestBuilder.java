...
public class AfipSoapRequestBuilder {
    ...
    private static void appendFeCAEReq(StringBuilder xml, Invoice invoice, Client client,
        ...
        appendDetRequest(xml, invoice, client, invoiceBreakdown, lastAuthorizedComprobanteNumber);
    ...
    private static void appendDetRequest(StringBuilder xml, Invoice invoice, Client client,
                                  InvoiceIvaBreakdown invoiceBreakdown, Long lastAuthorizedComprobanteNumber) {
        lastAuthorizedComprobanteNumber++;
        xml.append("<ar:Concepto>").append(invoice.getConcepto().getCode()).append("</ar:Concepto>")
                ...
                .append("<ar:CbteDesde>").append(lastAuthorizedComprobanteNumber.intValue()).append("</ar:CbteDesde>")
                .append("<ar:CbteHasta>").append(lastAuthorizedComprobanteNumber.intValue()).append("</ar:CbteHasta>")
    ...
    public static String buildFECompUltimoAutorizadoRequest(AfipAuth afipAuth, String cuit, Long sellPoint,
        ...
        xml.append("<ar:FECompUltimoAutorizado>");
        // Auth section
        xml.append("<ar:Auth>")
                .append("<ar:Token>").append(afipAuth.getToken()).append("</ar:Token>")
                .append("<ar:Sign>").append(afipAuth.getSign()).append("</ar:Sign>")
        ...
        xml.append("</ar:Auth>");
        // Request parameters
        xml.append("<ar:PtoVta>").append(sellPoint.intValue()).append("</ar:PtoVta>");
        xml.append("<ar:CbteTipo>").append(comprobante.getCode()).append("</ar:CbteTipo>");
        xml.append("</ar:FECompUltimoAutorizado>");
        // Footer SOAP
        xml.append("</soapenv:Body></soapenv:Envelope>");
        return xml.toString();
